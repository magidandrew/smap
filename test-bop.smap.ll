...
entry:
  ...
  %printb1 = call i32 @printb(i1 false)
  %printb2 = call i32 @printb(i1 true)
  %printb3 = call i32 @printb(i1 true)
  %printb4 = call i32 @printb(i1 true)
  %printb5 = call i32 @printb(i1 false)
  ret i32 0
}
